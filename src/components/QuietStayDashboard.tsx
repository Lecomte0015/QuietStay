...
export default function QuietStayDashboard() {
  ...
  // Essential data: KPIs, properties, bookings, owners — fire and forget, each section has its own loading state
  useEffect(() => {
    if (!user) return;

    // Each call is independent — don't wait for all to finish
    kpisHook.fetch();
